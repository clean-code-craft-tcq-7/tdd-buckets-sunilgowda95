...
def test_get_continuous_count():
    from continuous_range.continuous_range_count import get_continuous_count
...
def test_value_is_continuous():
    from continuous_range.continuous_range_count import value_is_continuous
